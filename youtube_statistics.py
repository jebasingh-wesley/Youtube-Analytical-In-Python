...
class YTstats:
    ...
    def get_channel_video_data(self):
        channel_videos = self._get_channel_videos(limit=100)
    ...
    def _get_channel_videos(self, limit=None): 
        ...
        #url = f"https://www.googleapis.com/youtube/v3/search?key={self.api_key}&channelId={self.channel_id}&part=snippet,contentDetails&order=2021-09-23T00%3A00%3A00Z"
        print(url)
